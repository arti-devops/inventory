...
public class PrintPdfService {
    ...
    public StreamResource printMissionDetailsFile(Mission mission, Member member){
        ...
        try {
            byte[] pdfBytes = pdfService.fillPdfForm(fieldValues);
            StreamResource resource = new StreamResource(String.valueOf("FM-CISSE.pdf"), () -> new ByteArrayInputStream(pdfBytes));
    ...
    public Map<String, String> getMissionDetailsFieldValues(Mission mission, Member member) {
        ...
        fieldValues.put("locationField", "Karshruhe (Allemagne)");
