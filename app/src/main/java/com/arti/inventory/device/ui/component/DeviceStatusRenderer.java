package com.arti.inventory.device.ui.component;
...
@Component
public class DeviceStatusRenderer<T extends Device> {

    private final SerializableBiConsumer<Span, T> deviceStatusComponentUpdater;

    public DeviceStatusRenderer() {
        deviceStatusComponentUpdater = (span, device) -> {
